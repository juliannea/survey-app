  ...
  <div>
    ...
    <div class="row text-center">
      ...
      <div class="col-12 col-md-8">
        ...
        <div class="container">
          <p class="text-left">
            Welcome to the job interest survey! The purpose of this survey is to
            obtain information about what job you may be interested in when you
            enter your work life. 
            <span class="text-bold">This poll is anonymous.</span>
          </p>
          <q-select
            outlined
          ...
          <p v-if="schoolError" class="text-red text-bold">
            Please select your school.
          </p>
          <p v-if="emailError" class="text-red text-bold">
  ...
  methods: {
    filterSchool(val, update) {
      ...
      update(() => {
        ...
        this.displayList = this.schoolList.filter((rec) =>
          rec.SchoolName.toLowerCase().includes(needle)
        );
      });
    },
    go() {
